...
> Важно: порты из пулов агентов (например, 8080–8199) НАМЕРЕННО НЕ входят в этот
...
| 8080 | зарезервировано (в reserve) | infra | пул Ворона, но заблокировано PDP |
| 8082 | зарезервировано (в reserve) | infra | |
| 8084 | зарезервировано (в reserve) | infra | |
| 8085 | зарезервировано (в reserve) | infra | |
| 8086 | mcp-apikeys (в reserve) | infra | пул Ворона, заблокировано PDP |
| 8087 | mcp-memory (в reserve) | infra | пул Ворона, заблокировано PDP |
...
| 9187 | postgres_exporter (в reserve) | infra | пул Штрейкбрехера, заблокировано |
...
и закоммить (через `lab-commit.sh`). Не добавляй сюда порты из пулов агентов —
